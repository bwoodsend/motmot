#!/usr/bin/env python
#
# motmot documentation build configuration file, created by
...
version = motmot.__version__
# The full version, including alpha/beta/rc tags.
release = motmot.__version__
...
latex_documents = [
    (master_doc, 'motmot.tex', 'Motmot Documentation', 'Brénainn Woodsend',
     'manual'),
]
...
man_pages = [(master_doc, 'motmot', 'Motmot Documentation', [author], 1)]
